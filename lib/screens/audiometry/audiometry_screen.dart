...
//录音请求
  ...
  void initState() {
    ...
    CalculateVolume();
    getSource();
    audioList = List.filled(_playSumNumber, null);
    _rightNumberList = List.filled(_playSumNumber + 1, 0);
    _sumNumberList = List.filled(_playSumNumber + 1, 0);
    _result = List.filled(_playSumNumber, null);
  }
